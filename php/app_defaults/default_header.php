...
<?php } ?>
	...
	.featuredItem { display:inline-block; }
	.featuredItem .MainImage { width:50%; float:left; border:1px solid blue; border-radius:5px; margin:0em 2em 1em 0em; }
	.featuredItem .LeftImage { width:25%; float:left; border:1px solid blue; border-radius:5px; margin:0em 2em 1em 0em;	}
	.featuredItem .RightImage { width:25%; float:right; border:1px solid blue; border-radius:5px; margin:0em 0em 1em 2em; }
	@media all and (max-width:760px) { .imageViewer img { float:none; width:100%; margin:0 auto; } .featuredItem .MainImage { float:none; width:100%; margin:1em auto; } .featuredItem .LeftImage { float:none; width:100%; margin:1em auto; } .featuredItem .RightImage { float:none; width:100%; margin:1em auto; } }
	...
	.webArticle .rightBlock { width:35%; float:right; margin:0em -0.5em 0em 1em; }
	.webArticle .leftBlock { width:35%; float:left; margin:0em 1em 0em -0.5em; }
	@media all and (max-width:760px) { 
		.article .articleImage { width:89%; } 
		.imageViewer img { float:none; width:100%; margin:0 auto; } 
		.newspaper .rightBlock { width:95%; float:none; margin:1em auto; } 
		.newspaper .leftBlock { width:95%; float:none; margin:1em auto; } 
		.webArticle .rightBlock { width:95%; float:none; margin:1em auto; } 
		.webArticle .leftBlock { width:95%; float:none; margin:1em auto; } 
